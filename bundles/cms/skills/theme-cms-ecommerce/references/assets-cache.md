...
Apply the same rules to campaign heroes, product/category/brand images, promotion banners, CTA backgrounds, testimonial/repeater images, and any new configurable image field. Core model accessors may already resolve their own image paths; inspect them before adding another prefix.
