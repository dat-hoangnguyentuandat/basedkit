...
- Theme-specific schema for announcement, header utilities, product categories, promotions, product groups, brands, trust promises, newsletter, footer menus, and floating controls.
- Homepage composition: announcement, header/search/cart, category mega-menu, campaign hero, trust promises, flash sale, bestseller/new arrivals, brands/categories, editorial, newsletter, footer.
...
- Product media galleries and card images have explicit responsive aspect ratios/crops instead of inheriting intrinsic dimensions.
...
- Slug, manifest, branding, business facts, colors, typography, copy, routes used, categories, products/brands/news/reviews.
