...
Prefer core types: `header`, `topbar`, `banner`, `slider`, `stats`, `product-list`, `product-group`, `post-group`, `partners`, `why-choose`, `customer-testimonials`, `contact-form`, `newsletter`, `product-filter`, `list-of-articles-by-category`, `editor`, `menu`, `social-links`, `fanpage`, `footer`, `floating-action-buttons`.
...
Recommended ecommerce homepage sequence:

1. Header global block
2. Announcement/promotion strip
3. Header search/account/cart utilities
4. Product category mega-menu
5. Campaign hero banner/slider
6. Trust promises/shipping/authenticity
7. Flash sale and featured deals
8. Bestseller/new-arrival product groups
9. Brand/category discovery
10. News/content/newsletter
11. Footer columns, policies, copyright, floating actions
