...
Ship optional route views such as `consulting`, `admissions`, `highlights`, or `courses` only when the design links to those existing routes. Do not invent frontend routes in a theme.
...
- Route views own page content, breadcrumbs, title/description sections, empty states, filters, and pagination.
