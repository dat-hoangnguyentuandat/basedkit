...
- Use real local bitmap assets for hero, team, services, reviews, and CTA where visual inspection matters.
...
- Set explicit aspect ratio or responsive height constraints for cards, hero, team/about, testimonial avatars, and logos.
- Use `object-fit: cover` for photos and `contain` for logos.
- Keep about/detail images aligned to nearby content; do not let portrait intrinsic dimensions create a full-page column.
