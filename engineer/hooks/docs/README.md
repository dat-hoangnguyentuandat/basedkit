...
**Blocked Patterns** (configured in `.claude/.basedkitignore`):
...
- Check throttle state: `cat /tmp/basedkit-noti-throttle.json`
- Test manually with echo pipe above

**Provider throttled:**
- Wait 5 minutes or delete `/tmp/basedkit-noti-throttle.json`
